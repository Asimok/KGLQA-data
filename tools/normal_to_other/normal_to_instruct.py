...
save_path = '/data0/maqi/KGLQA-data/datasets/NCR/ncr_rocketqa_1400_instruct'
...
for phase in PHASES:
    ...
    dataset = []
    with open(f'/data0/maqi/KGLQA-data/datasets/NCR/ncr_rocketqa_1400/{phase}.jsonl', 'r') as f:
        for line in f:

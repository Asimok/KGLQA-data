...
save_path = '/data0/maqi/KGLQA-data/datasets/QuALITY/Caption/quality_caption_and_rel_new2_instruct'
...
for phase in PHASES:
    ...
    dataset = []
    input_file = f'/data0/maqi/KGLQA-data/datasets/QuALITY/Caption/quality_caption_and_rel_new2/{phase}.jsonl'

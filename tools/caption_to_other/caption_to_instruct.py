...
save_path = '/data0/maqi/KGLQA-data/datasets/NCR/Caption/ncr_caption_only_caption_instruct'
...
for phase in PHASES:
    ...
    for idx, elem in enumerate(dataset):
        ...
        passage, answer, q = elem["context"], DICT_TO_LABEL[elem['label']], elem['query']

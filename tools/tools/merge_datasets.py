...
dataset_quality = '/data0/maqi/KGLQA-data/datasets/NCR/ncr_rocketqa_1400_instruct/train.jsonl'
dataset_race_train = '/data0/maqi/KGLQA-data/datasets/CCLUE/cclue_instruct/train.jsonl'
...
# 保存
save_path = '/data0/maqi/KGLQA-data/datasets/merge/ncr_and_cclue/train.jsonl'
# 文件夹不存在 则创建

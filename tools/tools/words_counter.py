...
if __name__ == '__main__':
    train_path = '/data0/maqi/KGLQA-data/datasets/quality_process/quality_normal_format/train.jsonl'
    ...
    print(pd.Series(word_count).describe(percentiles=[0.5, 0.75, 0.9, 0.95]))

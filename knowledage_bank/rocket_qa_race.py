...
if __name__ == '__main__':
    ...
    parser.add_argument("--type", type=str, required=False, default='test', choices=PHASES,
                        help="datasets")
    parser.add_argument("--datasets", type=str, required=False, default='middle',
                        help="middle or high")
    parser.add_argument("--max_word_count", type=int, required=False, default=2048,
                        help="max_word_count")
    parser.add_argument("--output_dir", type=str, required=False, default='race_normal_caption_and_rel',
                        help="output_dir")
    ...
    input_base_path = '/data0/maqi/KGLQA-data/datasets/RACE/race_normal_caption'

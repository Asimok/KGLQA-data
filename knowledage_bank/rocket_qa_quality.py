...
if __name__ == '__main__':
    """
    nohup python -u rocket_qa_quality.py --type train --max_word_count 2048 --output_dir quality_caption_and_rel > logs/quality_train.log 2>&1 &
    nohup python -u rocket_qa_quality.py --type dev --max_word_count 2048 --output_dir quality_caption_and_rel > logs/quality_dev.log 2>&1 &
    nohup python -u rocket_qa_quality.py --type test --max_word_count 2048 --output_dir quality_caption_and_rel > logs/quality_test.log 2>&1 &
    """
